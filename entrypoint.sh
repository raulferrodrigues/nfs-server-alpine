...
s3fs() {
  s3fs movies /movies -o passwd_file=minio-passwd,use_path_request_style,url=http://minio:9000
  s3fs tvseries /tvseries -o passwd_file=minio-passwd,use_path_request_style,url=http://minio:9000
}
